...
public class SportAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public SportAdapter(List<Sport>sportList){ mSportList = sportList; }
    ...
    @Override
    public void onBindViewHolder(@NonNull BaseViewHolder holder, int position) { holder.onBind(position); }
